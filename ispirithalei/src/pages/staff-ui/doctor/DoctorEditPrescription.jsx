        ...
        <div style={{marginBottom: 10}}>
            <Card>
                <CardContent>
                    ...
                    <br/>
                    <form>
                        <TextField id="dEditPName" name="dEditPName" label="PATIENT NAME" style={{margin: 0}}
                        ...
                        <TextField id="dEditPDignosis" name="dEditPDignosis" label="DIAGNOSIS" style={{margin: 0}}
                        ...
                        <div>
                            <TextField id="dEditMed1" name="dEditMed1" label="MEDICINE 1" style={{marginRight: 40}}
                                       InputLabelProps={{shrink: true,}}
                                       placeholder="Enter medicine 1 name" helperText="ex: Valparine" variant="outlined"
                                       required/>

                            <TextField id="dEditDose1" name="dEditDose1" label="DOSAGE" style={{margin: 0}}
                                       InputLabelProps={{shrink: true,}}
                        ...
                        <div>
                            <TextField id="dEditMed2" name="dEditMed2" label="MEDICINE 2" style={{marginRight: 40}}
                                       InputLabelProps={{shrink: true,}}
                                       placeholder="Enter medicine 2 name" helperText="ex: Valparine"
                                       variant="outlined"/>

                            <TextField id="dEditDose2" name="dEditDose2" label="DOSAGE" style={{margin: 0}}
                                       InputLabelProps={{shrink: true,}}
